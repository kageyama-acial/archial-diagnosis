...
const typeData: { [key: string]: {
  ...
  AABA: { name: "炎のストライカー", catch: "熱量そのものが、あなたの最大の武器だ。", color: "from-red-600 to-pink-500", img: "/char-rugby.png", strength: "あなたの強みは、「チームの熱量を増幅させる力」です。仲間の熱を吸収して自分のものにし、さらに大きくして返す——そんな「感情の増幅器」としての才能を持っています。スタートダッシュの速さと「まずやってみる」精神は、停滞したチームに突破口を作る最大の武器です。", role: "あなたが最も輝くのは、「チームに初速をつける場面」です。新しいことを立ち上げるとき、停滞した空気を打ち破るとき——そういった局面で、あなたの熱量は組織を救います。人を巻き込む力が高いため、「この人と一緒に仕事がしたい」と思わせることができます。", teamPosition: "チームの中でのあなたは、「点火役」です。誰かが火をつけなければ動き出さない場面で、あなたは自然と最初に燃え始める。その炎が周囲に広がり、気づけばチーム全体が同じ方向を向いています。", career: "あなたのキャリアは、「熱量が評価される環境で爆発的に伸びる」タイプです。意識したいのは、「直感を言語化する力」を磨くこと。あなたの感覚を言葉にして共有できれば、チームとしての成果が何倍にもなります。" },
  ...
  ABAA: { name: "熱血参謀", catch: "縁の下から、チームの可能性を最大化する。", color: "from-green-500 to-teal-500", img: "/char-softball.png", strength: "あなたの強みは、「守りながら、ここぞという場面で鋭いひらめきを放つ」独自のバランスです。誰がどんな強みを持ち、今どんな状態かを自然に把握するメンバー観察眼は、チームの課題を誰よりも早く発見する力になります。", role: "あなたが最も力を発揮するのは、「現状を守りながら、改善・革新のタネを見つけて提案する」役割です。「守りながら攻める」スタイルは、どんな職種においても希少価値があります。", teamPosition: "チームでのあなたは、「縁の下の参謀」です。前に出るリーダーではなく、そのリーダーを最も深いところで支える役割を担います。「あの人がいるから安心して戦える」そう思わせる存在感は、かけがえのない価値です。", career: "あなたのキャリアは、「信頼を積み重ねることで価値が倍増する」タイプです。意識したいのは、「ひらめきを積極的に発信すること」。あなたの閃きは本物です。もっと言葉にして届けることで、影響力がさらに広がります。" },
  ABAB: { name: "鉄壁ブレイン", catch: "あなたがいるから、チームは揺るがない。", color: "from-purple-600 to-indigo-500", img: "/char-handball.png", strength: "あなたの強みは、「緻密な設計でリスクを排除し、チームの安定を守る」力です。「念のため」「万が一」を常に考え、問題が起きる前に手を打つ先読み力は、多くの人が後から気づく課題をあなただけが事前に察知します。", role: "あなたが最も輝くのは、「組織の基盤を固める」役割です。リスク管理・品質管理・プロセス設計において、あなたの緻密さと論理性は他の追随を許しません。", teamPosition: "チームでのあなたは、「組織の土台」です。「あの人が大丈夫と言うなら大丈夫だ」——そう思わせる安定感は、どんな組織においても最も価値のある立ち位置のひとつです。", career: "あなたのキャリアは、「組織の規模が大きくなるほど価値が高まる」タイプです。意識したいのは、「自分の設計力を言語化して共有すること」。組織全体の精度が上がり、あなたへの信頼もさらに高まります。" },
  ...
  BABA: { name: "直感クリエイター", catch: "感じたことが、あなたの最高の羅針盤。", color: "from-pink-500 to-rose-400", img: "/char-tennis.png", strength: "あなたの強みは、「独自の感性と直感で、人や物事を丁寧に育て上げる力」です。感性が豊かなため、言葉にならない「何か」を察知し、それを形にする表現力がある。その力が周囲の人の心に深く響きます。", role: "あなたが最も力を発揮するのは、「クリエイティブな発想と丁寧な実行力が求められる仕事」です。アイデアを生み出すだけでなく、それを形にするまでのプロセスを一人でやり遂げる力がある。", teamPosition: "チームでのあなたは、「感性の担当者」です。あなたの独自の視点がチームに新しいインスピレーションをもたらし、他にはないオリジナルの価値を生み出します。", career: "あなたのキャリアは、「時間をかけるほど本物の評価が得られる」タイプです。意識したいのは、「自分の感覚を言葉で共有すること」。直感を伝える力を磨くと、あなたの世界観が多くの人に届くようになります。" },
  BABB: { name: "鋭利なイノベーター", catch: "あなたの論理が、世界を新しく塗り替える。", color: "from-violet-500 to-purple-400", img: "/char-skateboard.png", strength: "あなたの強みは、「独自の専門性と論理的思考で、既存の枠を壊す新しい価値を生み出す力」です。周囲が感情的になっている場面でも冷静にデータを分析し最適解を提示できる。その「鋭利な思考」は、最も求められる能力のひとつです。", role: "あなたが最も輝くのは、「既存の仕組みや方法を根本から見直す仕事」です。「仕組みを変える」「効率を上げる」「本質的な改善をする」という役割で、あなたは真価を発揮します。", teamPosition: "チームでのあなたは、「組織の外科医」です。チームが当たり前と思っていることに「本当にそれでいいのか」と問いかけ、より良い方向へ導く。", career: "あなたのキャリアは、「専門性を極めるほど唯一無二の存在になる」タイプです。意識したいのは、「改善案を人が動きやすい形で届けること」。相手が受け取りやすい言葉に変換する力を磨くと、影響力がさらに広がります。" },
  ...
  BBBB: { name: "孤高の職人", catch: "静寂の中でこそ、本物の答えが生まれる。", color: "from-slate-500 to-gray-400", img: "/char-climbing.png", strength: "あなたの強みは、「一人で深く考え、自分のペースで物事を極める」静かで圧倒的な専門性です。データや根拠を大切にし、「なぜそうなるのか」を徹底的に掘り下げ、表面的な答えでは満足しない。", role: "あなたが最も力を発揮するのは、「深い専門性が求められる仕事」です。どんな職種であっても、深い知識と高い論理性が評価されるポジションで、唯一無二の存在になれます。", teamPosition: "チームでのあなたは、「羅針盤」です。感情に流されず冷静に判断し、チームが混乱しているときや重要な意思決定の場面で静かに真価を発揮します。", career: "あなたのキャリアは、「静かな環境と高い裁量があるほど爆発的に能力が開花する」タイプです。意識したいのは、「自分の世界を少しだけ開くこと」。深い専門性を届ける相手を一人でも増やすと、影響力が静かに広がっていきます。" },
};
...
function Hearts({ count }: { count: number }) {
  return (
    <div className="flex gap-0.5">
      {[1,2,3,4,5].map(i => (
        <span key={i} style={{ color: i <= count ? "#C84B8B" : "rgba(123,92,246,0.15)", fontSize:"14px" }}>
          {i <= count ? "♥" : "♡"}
        </span>
      ))}
    </div>
          ...
          <div key={code} className="rounded-2xl p-4" style={{ background: "white", border: "1px solid rgba(123,92,246,0.1)", boxShadow: "0 2px 8px rgba(123,92,246,0.04)" }}>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-3">
                <Image src={typeData[code].img} alt={typeNames[code]} width={36} height={36} className="object-contain" />
                <div>
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-2">
          {typeCode.split("").map((val, i) => (
            <span key={i} className="px-3 py-1 rounded-full text-xs font-bold"
              ...
              {axisConfig[i].icon} {val === "A" ? axisConfig[i].label[0] : axisConfig[i].label[1]}
            </span>
          ))}
        </div>
      </div>
